...
#
# Rscript generate-r-packages.R cran > cran-packages.nix
...
ARTIVA = derive { name="ARTIVA"; version="1.2.3"; sha256="1jdvsslc8parz7wibcv51fx62brl2mc6i482hz43j1npsms2z1hl"; depends=[MASS igraph gplots]; };
ARTP = derive { name="ARTP"; version="2.0.4"; sha256="1f6ay9lyaqsc33b0larb8v6imp5adaycya84wif2sg32rv4gx3yl"; depends=[]; };
ARTool = derive { name="ARTool"; version="0.9.4"; sha256="12c3ikgp5ffnfdsdkpwv3k1ql6fal15g50aycfhlmm5dcccnwggg"; depends=[lme4 car plyr pbkrtest]; };
...
Anthropometry = derive { name="Anthropometry"; version="1.2"; sha256="15689jy85kf8j9w8yhffjfjw3lsdlv2w99za32p33shp32f3rvjz"; depends=[shapes rgl archetypes nnls depth FNN ICGE cluster biclust]; };
ApacheLogProcessor = derive { name="ApacheLogProcessor"; version="0.1.3"; sha256="1xa9ph3d6pr6gxy6nyrfg6g0ax56gspqqgw5g1rw3z6pfrr6yq4s"; depends=[foreach doParallel]; };
...
BACA = derive { name="BACA"; version="1.3"; sha256="1vbip7wbzix1s2izbm4058wmwar7w5rv3q8bmj9pm7hcapfi19k0"; depends=[ggplot2 rJava]; };
...
BinaryEPPM = derive { name="BinaryEPPM"; version="1.0"; sha256="088yg07966g09gv9hznhwfdka4yk0c9j0viy9x4ldmhxl9w9scv5"; depends=[Formula expm numDeriv]; };
...
CCAGFA = derive { name="CCAGFA"; version="1.0.5"; sha256="19gm5jpyrngsdi7nsy7r9bp3f06hysxlznzrxn94p3ilwylqq1vs"; depends=[]; };
...
CMplot = derive { name="CMplot"; version="1.0.1"; sha256="04pkpv0sl0aijp6b4sgn27bq54cn95zazikjlx5pwiyc8p0bzz86"; depends=[]; };
...
CatDyn = derive { name="CatDyn"; version="1.1-0"; sha256="0bdixcf1iwbmjd2axi6csrzms25ghdj4r6223qhk2b54wlmbzaiz"; depends=[optimx BB]; };
...
ClustMMDD = derive { name="ClustMMDD"; version="1.0.1"; sha256="0pzascdiadhvx4xjxa6kjw5kkmj3izphz2f86jnimyn5fid7cl02"; depends=[Rcpp Rcpp]; };
...
DAISIE = derive { name="DAISIE"; version="1.0"; sha256="0s26fc6gx9fg47k3wx11iw72b1hbawb0p7ixqz420ca48x6n95nd"; depends=[deSolve]; };
...
DLMtool = derive { name="DLMtool"; version="1.35"; sha256="1qcc5q35a68m468ip1mhij2g0qzz5fhcjzax11a8n2fl9x2s9d57"; depends=[snowfall boot MASS]; };
...
DescTools = derive { name="DescTools"; version="0.99.11"; sha256="0ccqgx6w7x55h5pd76hjyq79g0cdyw2m0w1h55kw4chqj0ibqizy"; depends=[manipulate boot mvtnorm foreign]; };
...
ETLUtils = derive { name="ETLUtils"; version="1.3"; sha256="13xq9i9fr34kx1nym7nr02gynshzm4jjn4qzx6ydg044b7xl57jp"; depends=[ff bit]; };
EW = derive { name="EW"; version="1.1"; sha256="0wc3v9qisiikvlp28xhlgsxb92fhkm6vslia6d0vpihyai0p1h1g"; depends=[]; };
EWGoF = derive { name="EWGoF"; version="2.1"; sha256="10p392n003sxn8l9sfnksi789k1w191rmkah6gxhji5f41gib5rh"; depends=[Rcpp Rcpp]; };
...
EpiModel = derive { name="EpiModel"; version="1.1.6"; sha256="0h3bbvk9qyhc0jml2jd21dahi1v00alar67jkzpwnavvmcgd8a3s"; depends=[deSolve network networkDynamic tergm doParallel ergm foreach RColorBrewer statnet_common]; };
...
ExomeDepth = derive { name="ExomeDepth"; version="1.1.5"; sha256="11ff89c080855wmvglapif7h3wmk6zrgfqcb0kshy4jglpwkz52x"; depends=[aod VGAM]; };
...
FHtest = derive { name="FHtest"; version="1.2"; sha256="033p90zzlgx2galzp2iwwpg29hhhgscqmqkwpr69y2ck3nj3hz0v"; depends=[interval KMsurv survival perm MASS]; };
...
FSInteract = derive { name="FSInteract"; version="0.1.1"; sha256="0hlmz0sc4l9vmb4b2y3j95gh39m1jqrp9bvqsjjqdr0ly1lb7mvm"; depends=[Rcpp Matrix Rcpp]; };
...
FastHCS = derive { name="FastHCS"; version="0.0.5"; sha256="02ds9syqh8wpjrqibdv3kqxcyijclm572daqrj262b4b6211v46x"; depends=[matrixStats robustbase Rcpp RcppEigen]; };
...
GSIF = derive { name="GSIF"; version="0.4-6"; sha256="00m5djgc443678nwnmvgqv070g67pbvp1ci1x8gp7van8knjn5zq"; depends=[sp RSAGA dismo rgdal raster aqp plotKML gstat plyr]; };
...
GUTS = derive { name="GUTS"; version="0.9.3"; sha256="0gyi5vlr1r35qn3gj788lh9xrb7dz03r57hxk11x8w72kv415pih"; depends=[Rcpp Rcpp]; };
...
Haplin = derive { name="Haplin"; version="5.5"; sha256="12wkj5x1s920xs0xzhxk0dswmwan7x20fw5sj6cx29n013h1gkam"; depends=[GenABEL DatABEL mgcv MASS SuppDists snow]; };
...
LakeMetabolizer = derive { name="LakeMetabolizer"; version="1.3.3"; sha256="06mgn5dgdw0gaw1za20cabs4bx6q5bgv0x09imxhskik76kini01"; depends=[rLakeAnalyzer plyr]; };
...
Luminescence = derive { name="Luminescence"; version="0.4.4"; sha256="0b7a55aqishi6jwxlpkbakfr38brjd4c61n4mcbsg6nwg7qiz1v7"; depends=[XML shape rgl matrixStats raster zoo bbmle data_table Rcpp minpack_lm Rcpp]; };
...
MCMC_qpcr = derive { name="MCMC.qpcr"; version="1.2"; sha256="1v8jkxxy7z1r3l9jlshhsq6634chf30d9bb1w80iqrjfn6aamn69"; depends=[MCMCglmm ggplot2 coda]; };
...
MInt = derive { name="MInt"; version="1.0.1"; sha256="1nk02baainxk7z083yyajxrnadg2y1dnhr51fianibvph1pjjkl6"; depends=[glasso trust MASS testthat]; };
...
MTurkR = derive { name="MTurkR"; version="0.6.5.1"; sha256="0yg2ycramz0rpac4bfyq8wciyv9jl93al0qsdbzrl7c37z151w3l"; depends=[RCurl digest XML]; };
...
MixGHD = derive { name="MixGHD"; version="1.6"; sha256="0lmv1yspjn9m5kw0zd2sabgy33zd77p0nqfvs9cvy3ldvz35095i"; depends=[MASS mclust Bessel mvtnorm ghyp numDeriv mixture]; };
...
MultiRR = derive { name="MultiRR"; version="1.0"; sha256="0m2v13cygabjbsz0fwxwh03csd3yfdpzk4yfvx8lrim9m90026hz"; depends=[MASS lme4]; };
...
NEff = derive { name="NEff"; version="1.1"; sha256="16ys1fi28kbzg3am9vz1c5pc9x0ac47pl6za04h63lspk99yplzk"; depends=[msm bit]; };
...
NMF = derive { name="NMF"; version="0.20.6"; sha256="0mmh9bz0zjwd8h9jplz4rq3g94npaqj8s4px51vcv47csssd9k6z"; depends=[pkgmaker registry rngtools cluster stringr digest gridBase colorspace RColorBrewer foreach doParallel ggplot2 reshape2]; };
...
OpenMx = derive { name="OpenMx"; version="2.2.4"; sha256="1w72ikysda45zbvwlr297fqqjl3law2r6m3c9n9j5d8r3clfhqyl"; depends=[digest MASS RcppEigen StanHeaders BH]; };
...
PoisBinOrdNonNor = derive { name="PoisBinOrdNonNor"; version="1.0"; sha256="1x41mwvdria48cjr3dyq4d0l8v8kp3v9aayfl6jfxy6dhjwdg4vz"; depends=[Matrix corpcor MASS GenOrd BB]; };
PoisBinOrdNor = derive { name="PoisBinOrdNor"; version="1.0"; sha256="0big81yvbz9qyw4h6h1ak2wzvn56g1d1809m7lnmd2kx780i2hsf"; depends=[Matrix corpcor mvtnorm psych GenOrd]; };
...
PopVar = derive { name="PopVar"; version="1.1"; sha256="1125yynxdg13r84wzbm2h50yqhw1if0zrkaqlcjvmavymmx0vln2"; depends=[qtl rrBLUP]; };
...
QuasiSeq = derive { name="QuasiSeq"; version="1.0-8"; sha256="113pxmvwwn331g5dcv2zwsvvi5jgc1v41f38sw9gms06i8x3a7q6"; depends=[mgcv pracma]; };
...
R_filesets = derive { name="R.filesets"; version="2.7.2"; sha256="0jlbpvj1ijjknjrb48x26c1ngkv7gl42fmk5g9sqaivm69d76nav"; depends=[R_oo R_methodsS3 R_utils R_cache digest]; };
...
R_utils = derive { name="R.utils"; version="2.1.0"; sha256="03pi6pkcsq65fv7cn4x74cj050dc8x5d4xyg930p6f7flk788xaz"; depends=[R_oo R_methodsS3]; };
...
RAM = derive { name="RAM"; version="1.2.1"; sha256="11ymhx0nk113cy068s52hjj38y8glv8nh24yljqqvr1fd9fmy64g"; depends=[vegan ggplot2 ape gridExtra RColorBrewer gplots plyr reshape2 scales labdsv ggmap permute VennDiagram data_table FD MASS RgoogleMaps lattice reshape ade4 phangorn phytools Hmisc]; };
...
RDS = derive { name="RDS"; version="0.7-2"; sha256="143pb13wg0ms9zaiilb3ylqj6r6bcy4iqbq19j57z33i1q6ll51c"; depends=[gridExtra ggplot2 igraph reshape2 scales]; };
...
RFgroove = derive { name="RFgroove"; version="1.0"; sha256="13cf2grp87j7mm0lqf8f65d1pzypjp3b7g09f35x6dfirvc7lkdy"; depends=[randomForest wmtsa fda]; };
...
RInside = derive { name="RInside"; version="0.2.13"; sha256="0cfhljdai9kkw5m01mjaya0s02g4g1cy1g4i0qpjkhgqyihsh7dy"; depends=[Rcpp Rcpp]; };
...
RNeXML = derive { name="RNeXML"; version="2.0.3"; sha256="02aaacd2vs2iccjabx1bcrimhzr1kpzhkx9l50amwilj8q8ackr0"; depends=[ape XML plyr taxize reshape2 httr uuid]; };
...
RSPS = derive { name="RSPS"; version="1.0"; sha256="0ynxhgnxsf27qm8r5d9lyd59zksnc3kvx35hy25vff8j3bg7fqgi"; depends=[lattice plyr gridExtra]; };
...
RbioRXN = derive { name="RbioRXN"; version="1.5.1"; sha256="0lc43wm986y3xbdh1xihn7w583cql9kvj6rb018pn06ghz153i0d"; depends=[plyr RCurl gdata data_table stringr]; };
...
RecordLinkage = derive { name="RecordLinkage"; version="0.4-8"; sha256="0wjjrgmz7m11hhsw7dcg3745255xckdgrqp3xlqkyh2kzbyr9rp4"; depends=[DBI RSQLite ff ffbase e1071 rpart ada ipred evd data_table nnet xtable RSQLite]; };
...
Rtsne = derive { name="Rtsne"; version="0.10"; sha256="14270gg0fp3imq9rafqj56ld56kzby7yyf5rg9z0wlimm7s72hy5"; depends=[Rcpp Rcpp]; };
Rttf2pt1 = derive { name="Rttf2pt1"; version="1.3.3"; sha256="16bnhrg86rzi4g4zf235m1g8amyhcwxpw0wgcxynfiinm2fl4y1n"; depends=[]; };
Rtts = derive { name="Rtts"; version="0.2.5"; sha256="0c0160zsdmp5ywni7qx9kdxvkqnxdsayflsli2d3padmm8ll5d7s"; depends=[RCurl]; };
...
SpatialVx = derive { name="SpatialVx"; version="0.2-3"; sha256="1xc8xcnp507l8smb05040zz1cgyx48p645rrijqdibb2xp4gvgk9"; depends=[spatstat fields smoothie smatr turboEM distillery maps boot CircStats fastcluster waveslim]; };
...
SubpathwayGMir = derive { name="SubpathwayGMir"; version="1.0"; sha256="1rw94idhbnaszr2xv1wgnjcxlnxkml912pvmqh2a1nqpwca5mscy"; depends=[XML igraph]; };
...
Surrogate = derive { name="Surrogate"; version="0.1-6"; sha256="1yqpwzihs7phydlbywr8cz3fq2bcin3b9v3q807bvp9mpjhi7ihg"; depends=[MASS nlme msm lme4 rgl lattice latticeExtra]; };
...
VarSelLCM = derive { name="VarSelLCM"; version="1.1"; sha256="04iqlkphlj8xwz2qrabqphilj3s5hspasawh92f94mvfjd6vgscl"; depends=[Rcpp mclust Rcpp RcppArmadillo]; };
...
WhiteStripe = derive { name="WhiteStripe"; version="1.1.1"; sha256="1naavgkvgky3lzg5vlz11g589cxr0fgiqz2waz86da1ksk4a19gw"; depends=[oro_nifti mgcv]; };
WhopGenome = derive { name="WhopGenome"; version="0.9.2"; sha256="0bh96bcv8hknhqfjw4wi1ixdd8fcsfzlhwk89knp18br2pm5dxpx"; depends=[]; };
...
aSPU = derive { name="aSPU"; version="1.33"; sha256="1fm4ra96mjmfbq2p3a703xsm5ymynf7w8il5z7jz8r9ahym8p44w"; depends=[]; };
...
acc = derive { name="acc"; version="1.0.2"; sha256="1z7hncgd43mc84v3wdcqpkp3gxsdyvh7h8s6qvgap2lp04m1j74l"; depends=[zoo PhysicalActivity mhsmm timeDate]; };
accelerometry = derive { name="accelerometry"; version="2.2.5"; sha256="00mn09j7y39sc7h5srnnfk2l73vhh6zq7rzc0vckfvs72lncmwv5"; depends=[Rcpp Rcpp]; };
...
acp = derive { name="acp"; version="2.0"; sha256="11ij2xhnkhy7lnzj8fld7habidb9av8a2bk22ycf62f556pqf533"; depends=[tseries quantmod]; };
...
alphaOutlier = derive { name="alphaOutlier"; version="1.0.1"; sha256="1zl80q08vcyvyakfv6cd444m6l5z14p7bv9jf8kpg4dad3d63mhz"; depends=[Rsolnp nleqslv quantreg]; };
...
analogue = derive { name="analogue"; version="0.16-3"; sha256="0lv8ljf10jdrgrd59pcjdi1wvjfd0j6qb87xzfx5k8kcp9awx4h6"; depends=[vegan mgcv MASS brglm princurve lattice]; };
...
ape = derive { name="ape"; version="3.3"; sha256="1zdgszyi5kwfj3kccx35q8z57p53zdp819hjqdw5z8y6q7b49j1c"; depends=[nlme lattice]; };
...
arm = derive { name="arm"; version="1.8-5"; sha256="0mjsjqrim2a6ds8gxrbdyp96b6sz1vjsqic80a5izrc2z9bml5p5"; depends=[MASS Matrix lme4 abind coda nlme]; };
arnie = derive { name="arnie"; version="0.1.2"; sha256="14xkgyfn9zvkbgram15w7qzqc5pl1a8ig66cif7a79najrgd914r"; depends=[]; };
aroma_affymetrix = derive { name="aroma.affymetrix"; version="2.13.2"; sha256="0km1mhy8p6pksa0wnwx0cxbfgipi6c7xn7913agsqdpfbfphhm8j"; depends=[R_utils aroma_core R_methodsS3 R_oo R_cache R_devices R_filesets aroma_apd MASS matrixStats]; };
...
aroma_core = derive { name="aroma.core"; version="2.13.1"; sha256="1085qh092sij4c3wl3g10wc8agr13bnqbrq3k4fnm53jpa786qsx"; depends=[R_utils R_filesets R_devices R_methodsS3 R_oo R_cache R_rsp matrixStats RColorBrewer PSCBS]; };
...
biclust = derive { name="biclust"; version="1.2.0"; sha256="03vkj7zp3dl4zbv2gzv9pahcd1018lbv4ixghvv1g0fsbndrybdg"; depends=[MASS colorspace lattice flexclust]; };
...
bigml = derive { name="bigml"; version="0.1.2"; sha256="0vl5krjbgckknxwl26b2hn63jhb80zbn7abpckhxzxfxzncpnfz9"; depends=[RJSONIO RCurl plyr]; };
...
boxr = derive { name="boxr"; version="0.2.6"; sha256="1b7xvblw2a1p8sr1gxrak404d43haa4kk7blnyir1pql8dcw24jd"; depends=[httr httpuv assertthat stringr dplyr digest jsonlite]; };
...
brms = derive { name="brms"; version="0.2.0"; sha256="1i515sz3paiwwkmgglqzb2gzb2y6m99kp95xaarpawsja8nxi2j0"; depends=[ggplot2 Rcpp abind coda ggmcmc gridExtra]; };
...
cati = derive { name="cati"; version="0.99"; sha256="1xghdqmqfwi0wnzvrd896z4snyjqqs9kw3whmkd3cph8zf0jl931"; depends=[nlme ade4 ape e1071 mice rasterVis hypervolume FD geometry vegan]; };
...
clere = derive { name="clere"; version="1.1"; sha256="0r6yzdfgzyl8y5qlj78azv0f6gp3kadnk4zycsrva1cc3qa7lv1c"; depends=[Rcpp Rcpp RcppEigen]; };
...
clickstream = derive { name="clickstream"; version="1.1.4"; sha256="0z73phz31j7n49xmwdgv293qbg6ldfgibpd5713qyk7qkhk8hvl7"; depends=[igraph plyr Rsolnp data_table arules]; };
...
commonmark = derive { name="commonmark"; version="0.2"; sha256="11a6qy0pcdn1ybvzzk04rn8lxi1zmr8bbd3bb8m8d9n7l5163cgh"; depends=[]; };
...
compareGroups = derive { name="compareGroups"; version="3.0.1"; sha256="185lz69al72p4s354vn6gvha3zbhyvf2fsfym0knyspgl08q3m2g"; depends=[Hmisc gdata xtable SNPassoc survival epitools HardyWeinberg]; };
...
coneproj = derive { name="coneproj"; version="1.6"; sha256="1bx0j9r83c944aklyq4lxdhmskyiwh4f6i2fim5fi6hpf6n9ajds"; depends=[Rcpp RcppArmadillo Rcpp]; };
...
covr = derive { name="covr"; version="1.0.0"; sha256="1svq2dcqnd5iwq75nk38lxa3dshiwil2ksd3666713agbqzikgcz"; depends=[jsonlite rex devtools httr crayon htmltools]; };
...
cp4p = derive { name="cp4p"; version="0.2"; sha256="1rm6dgfiv2dx17svlzyaiqiqkpip24ns5wp8lddr6gmpws581ywl"; depends=[MESS]; };
...
crayon = derive { name="crayon"; version="1.2.1"; sha256="0cj5vx2v8jz10ak4sx55nj37qkkj9jhl1jp9njanawnyn7ww42sc"; depends=[memoise]; };
...
curl = derive { name="curl"; version="0.7"; sha256="13592ilw5zln61prij5imdvknv6mfq5qwxgzc1w7zk75dqs9ziyc"; depends=[]; };
...
ddalpha = derive { name="ddalpha"; version="1.1.1"; sha256="1i0zchgp5pdfa9p1mpd9svbigbn01jqfl47nnqixzlgz1808929c"; depends=[MASS class robustbase Rcpp BH Rcpp]; };
...
diagonals = derive { name="diagonals"; version="0.2.0"; sha256="185nibadqvi6cvablh84ijs52wn2vg0xrc2idizll6lcxhf441yq"; depends=[]; };
...
discSurv = derive { name="discSurv"; version="1.1.0"; sha256="0jj055w0m749fdd90cqlyklxnjxfjhly179lmg9xfl69w4xrjc2l"; depends=[functional Matrix matrixcalc mvtnorm numDeriv caret mgcv]; };
...
drgee = derive { name="drgee"; version="1.1.2"; sha256="1idnwa9yy1bijwbz9ffvc4q4lynhisgjvp3jcik3z3r96wfmz2ks"; depends=[nleqslv survival]; };
...
ecp = derive { name="ecp"; version="2.0.0"; sha256="0cr3rzvd4bahg5idd857mgp005n075xql5kvjw0smsjbjh4p84wq"; depends=[Rcpp Rcpp]; };
...
emil = derive { name="emil"; version="2.0.2"; sha256="16fkf5ns6pw0nrpysr1yy5hwwg59mkfa84skajchfvq75aw6hwbi"; depends=[dplyr data_table ggplot2 lazyeval magrittr tidyr]; };
...
empiricalFDR_DESeq2 = derive { name="empiricalFDR.DESeq2"; version="1.0.3"; sha256="0h2mcdw4v3ac6dn0s4z37l4sdzbi12sxrnn0f0gc9z207dyyf6w3"; depends=[]; };
...
evmix = derive { name="evmix"; version="2.6"; sha256="1rc52mqmzl05n5n1lr990czqgpq9h2x8shnv6s7hvr8896kjasjm"; depends=[MASS gsl SparseM]; };
...
evolqg = derive { name="evolqg"; version="0.1-5"; sha256="1s9jh14ycymlajc285cczr9m529vv6la4bkv0lgk3dc0557m7q5w"; depends=[plyr Rcpp reshape2 ggplot2 magrittr tidyr vegan ape phytools mvtnorm Rcpp]; };
...
fastHICA = derive { name="fastHICA"; version="1.0.2"; sha256="1h794ybbii0k7v3x0r1499zxdqa1i1dpi3i7idzqdrffnb5kmwlv"; depends=[fastICA energy]; };
...
fastR = derive { name="fastR"; version="0.10"; sha256="0bd164lij12yfqjykxj1m4rma7x2y4kpv4fspjlp1vpwqn3h4lb9"; depends=[mosaic lattice mosaicData]; };
...
ffbase = derive { name="ffbase"; version="0.12.0"; sha256="1yi5rbl1p3dyib75v2wgf2wnji9yzi88vyy2x3awmjnqgcdj2ibs"; depends=[ff fastmatch bit]; };
...
forecast = derive { name="forecast"; version="6.1"; sha256="1hwv3arcpkkhpj5n2dvpw2fyx687b6x6yakxx55cw9rrka70rx1k"; depends=[zoo timeDate tseries fracdiff Rcpp nnet colorspace Rcpp RcppArmadillo]; };
...
forestFloor = derive { name="forestFloor"; version="1.4"; sha256="152b5pq9901bdik3dqmn4gb0aiyl8zf8mg88d8xnz839aildp2fw"; depends=[Rcpp randomForest rgl kknn trimTrees Rcpp]; };
...
fslr = derive { name="fslr"; version="1.4.4"; sha256="0k6973hd1q54q6243lir4xi3wlrsiqb526qsh9gryx9ha4iv0rmc"; depends=[stringr oro_nifti matrixStats R_utils scales]; };
...
geesmv = derive { name="geesmv"; version="1.1"; sha256="1xijdjmkg6nw2y1556zbaic969dg23np0wrb9ncknsrhq4aa28pa"; depends=[nlme gee matrixcalc MASS]; };
...
geomorph = derive { name="geomorph"; version="2.1.5"; sha256="0xys2gwin16h4ahcjy3m49sslypilxlcgrnky19vv4aagrydq776"; depends=[rgl jpeg ape geiger phytools]; };
...
ggdendro = derive { name="ggdendro"; version="0.1-15"; sha256="11g7jkf3zsil0z5mzbrfxwrgkpw6p5p1d4jkr0qq853b6rsxn5iw"; depends=[MASS ggplot2]; };
...
greyzoneSurv = derive { name="greyzoneSurv"; version="1.0"; sha256="115i0d4fy4p4g4vd419hj9f23hi8cbiyfilgpgmag91ilr1xpcdp"; depends=[survival Hmisc survAUC]; };
...
gromovlab = derive { name="gromovlab"; version="0.6-16"; sha256="0ndi4i91fnndvpp3xmr405a62vq5gjagw2qrvcmq1q6cgg7bj17q"; depends=[igraph phangorn glpkAPI quadprog cluster]; };
...
hglm = derive { name="hglm"; version="2.1-0"; sha256="02d5m7j7c1z40kih1ywvnd32sdlshgsgagsbh9avhhpcg7lxswj9"; depends=[Matrix MASS hglm_data]; };
...
hsdar = derive { name="hsdar"; version="0.1.5"; sha256="1ii83dpndshq8d00f3dxrzcxqplcc5b85b9cixxbda5bpvrlkpg1"; depends=[sp raster rgdal rootSolve signal]; };
...
kernelFactory = derive { name="kernelFactory"; version="0.2.2"; sha256="1ms6732s17vx120xr2l423qmj0h880r522zsgp474pq3fxc0mr48"; depends=[randomForest AUC genalg kernlab]; };
...
kml = derive { name="kml"; version="2.3"; sha256="0954z6gy5qbi117vfxipcz3cq91qq4g968xzcphb1dd7w328wvb1"; depends=[clv longitudinalData]; };
kml3d = derive { name="kml3d"; version="2.3"; sha256="0dlpxp8bbrwgblrl1hnc1ip592abc6sdcl87s4m6jwgfaxjcq7a8"; depends=[clv rgl misc3d longitudinalData kml]; };
...
knitcitations = derive { name="knitcitations"; version="1.0.6"; sha256="18jfrzazbk8cy9i7qvmmrn8c5cmkxvmdd894jpvak2gplxvsdx91"; depends=[RefManageR digest httr]; };
...
lamW = derive { name="lamW"; version="0.1-1"; sha256="1ndf3rkkp87pivhymyqa3n5ng5y1kaa79ay84p4yk4z4h2887nq3"; depends=[Rcpp Rcpp]; };
...
lawn = derive { name="lawn"; version="0.1.0"; sha256="0vv2qmz6a692ammh3jxnpq3b669s8cx61krmb97jlwjy2nb6r81i"; depends=[V8 jsonlite magrittr]; };
...
lfe = derive { name="lfe"; version="2.3-1709"; sha256="0q6va05n38225a7sbk0ykdrygzjk6js6afm2vyy5fac1hbvihb05"; depends=[Matrix Formula xtable]; };
...
longitudinalData = derive { name="longitudinalData"; version="2.3"; sha256="0ld2saga04if2zp3ylz720q8451f7a7aiva5hpj471wxd0948592"; depends=[clv class rgl misc3d]; };
...
mRMRe = derive { name="mRMRe"; version="2.0.5"; sha256="0h9ilbkyjqwiyiys1l66zhxwlxlygkkzx59saf0a68nyq2b69afy"; depends=[survival igraph]; };
...
manifestoR = derive { name="manifestoR"; version="1.0-1"; sha256="1008bz2vsmhx0sx6kc55z8dhlfinbadagz4hd0p50c4q86ibl7lh"; depends=[NLP tm dplyr httr jsonlite functional zoo psych]; };
...
mapmisc = derive { name="mapmisc"; version="1.2.4"; sha256="07h237sgsycagn61rharb09q9s8da777hzngh4py1sbv6gfyqpv8"; depends=[sp raster]; };
...
markovchain = derive { name="markovchain"; version="0.2.1"; sha256="0ix7sdcnsc4bl9diddfl4q0lmq1nq8bp1d7arxzcjj4zy35vhkv5"; depends=[igraph Matrix matlab expm Rcpp RcppParallel Rcpp RcppParallel]; };
...
matchingMarkets = derive { name="matchingMarkets"; version="0.1-4"; sha256="096yknmzla2qq2vkaxna5f8mclayjn5baff3cm8ik95zy7j3lrjp"; depends=[Rcpp lpSolve partitions Rcpp RcppArmadillo RcppProgress]; };
matchingR = derive { name="matchingR"; version="1.0.1"; sha256="0qqk2zcyj0m3r9q0lclb39gdrjqqjlaxvk3cxpfah7hxhhkrk4mc"; depends=[Rcpp Rcpp RcppArmadillo]; };
...
metagear = derive { name="metagear"; version="0.1"; sha256="1c00y7p7063f3c1ar17r9ij5j4chzyispg0wprkjaaz0mx9w1hb0"; depends=[gWidgetsRGtk2 gWidgets stringr metafor MASS Matrix]; };
...
meteoForecast = derive { name="meteoForecast"; version="0.45"; sha256="0p74w5zcibzw2vpbyl4jb2wzpz0pki1n1l66hjs6dnkrn52zph95"; depends=[raster sp zoo ncdf]; };
...
mets = derive { name="mets"; version="1.1.1"; sha256="1myqcds9glsy3fwzr7v711xzk7gmvy2cb4x3qgj1kxa90d1d50hz"; depends=[timereg lava numDeriv Rcpp survival Rcpp RcppArmadillo]; };
...
miceadds = derive { name="miceadds"; version="1.2-0"; sha256="01gbkpmmd81v5yhj3jparp7li1jzq91f5zk65dhcd8g3a0k0952m"; depends=[MASS mice mvtnorm pan Rcpp sirt TAM lme4 MBESS pls mitools bayesm inline car foreign sjmisc multiwayvcov Rcpp RcppArmadillo]; };
...
mitml = derive { name="mitml"; version="0.2-2"; sha256="11pgwa1cxf1i2qkm8gyzxsjkhg40r75gk2k1lwaqpqgi7vs3drbs"; depends=[pan haven]; };
...
mixAK = derive { name="mixAK"; version="4.0-5"; sha256="1kdcia6j2dw4q1rbrswx9h8ivzrnw8hrg5a206jykmsdbngbifx5"; depends=[colorspace lme4 fastGHQuad mnormt coda]; };
...
mixlm = derive { name="mixlm"; version="1.0.8.5"; sha256="1yihyfjbi6y9vs7cgsxxs4nhlhcb67qpcc38ir6p32mzs6r8ycl3"; depends=[multcomp pls pracma leaps lme4 car]; };
...
mkin = derive { name="mkin"; version="0.9-35"; sha256="0ac71wkl8b034l1bbv8qr5ynvpl8l9j31ych5v5pf6mmqs62bwnr"; depends=[minpack_lm rootSolve FME deSolve]; };
...
mnlogit = derive { name="mnlogit"; version="1.2.1"; sha256="0sanys9y64wlqqclsl2p8bghh62apzxnyjshaihdvvy02y7cnzcw"; depends=[mlogit lmtest Formula]; };
...
mongolite = derive { name="mongolite"; version="0.3"; sha256="022b3ibahb2bq48hhgcli91hwsfxadimzdh0pyrhzi8vh5da9613"; depends=[jsonlite]; };
...
mosaic = derive { name="mosaic"; version="0.10.0"; sha256="0hhln6kfxdk6z4rmi3378cs18ziwa5awi53ylnx5kva7f42m5jxr"; depends=[car dplyr lattice ggplot2 mosaicData lazyeval MASS reshape2 plyr readr latticeExtra gridExtra ggdendro]; };
...
mvabund = derive { name="mvabund"; version="3.10.4"; sha256="1hza09nghgz0iyfayqabf5d0yb6zqnvhwmprif6y9qix8jscilwl"; depends=[Rcpp MASS tweedie statmod]; };
...
myTAI = derive { name="myTAI"; version="0.1.0"; sha256="0qz2mm3ca5i93kz3pg8llpniix3vdy7mxz1n8k36iap09rbsrgmi"; depends=[Rcpp nortest fitdistrplus foreach doParallel dplyr Rcpp]; };
...
nabor = derive { name="nabor"; version="0.4.6"; sha256="0kd0h8n5yrn16vrfdchdiqzws05q0fm8z577p20dm18gdcs2vbxv"; depends=[Rcpp Rcpp RcppEigen BH]; };
...
nat = derive { name="nat"; version="1.6.6"; sha256="0jqpj9hrz8xqikl84b9nzi1hh82cmry18vpca7s8dl4824yadkrw"; depends=[rgl nabor igraph filehash digest nat_utils plyr yaml]; };
...
ncdf_tools = derive { name="ncdf.tools"; version="0.7.1.295"; sha256="1jgxivmg2gzvkn09n13i5xr1v0xcyp5ckhwxz6g5kdh9z2dkjhc2"; depends=[RNetCDF chron abind plotrix raster RColorBrewer JBTools]; };
...
neotoma = derive { name="neotoma"; version="1.3.0"; sha256="0a5fmas441zl479vfndgyhanp5iivzdp5zqrpnr3pvgf3wfdnppd"; depends=[RJSONIO RCurl plyr reshape2]; };
...
netgen = derive { name="netgen"; version="1.1"; sha256="0wbsssskhih6fyb0xfpnd3sjp25z8h0jyy3437ykgh7g24hh0i1z"; depends=[BBmisc mvtnorm lhs checkmate ggplot2 lpSolve igraph stringr]; };
...
nlts = derive { name="nlts"; version="0.2-0"; sha256="03il87n9gj5sqq50b2qpjb1jjf0grhqlfnp8wdxgcqpradgm6rnl"; depends=[locfit acepack]; };
...
nodeHarvest = derive { name="nodeHarvest"; version="0.7-1"; sha256="1qhzi058wcz78n6isvgvdcjl5pzc1j9bfivfg6wvypvws0sszwsx"; depends=[quadprog randomForest]; };
...
odeintr = derive { name="odeintr"; version="1.3"; sha256="12y5hr6f7bj3aqj4gd0hlj495c5163jn0liksspk5jpqcmpsgdg3"; depends=[Rcpp Rcpp BH]; };
...
ordinalCont = derive { name="ordinalCont"; version="0.4"; sha256="1inms74l4zx6r526xd0v79v18bcqa76xwsgfvap0fizyv2dvgpim"; depends=[fastGHQuad boot ucminf]; };
...
pander = derive { name="pander"; version="0.5.2"; sha256="0zs2c00dr0vph9d4par3zcisnyqa98rqym8fpya02ka28qajjiia"; depends=[digest Rcpp Rcpp]; };
...
parallelSVM = derive { name="parallelSVM"; version="0.1-6"; sha256="0w9fbxah6yxkz89x3j4aiin2fb3y9835ha2bk4l1h7znz1hfhybp"; depends=[foreach doParallel doMC e1071]; };
...
pcalg = derive { name="pcalg"; version="2.2-0"; sha256="1cgir5h9g8v3kjmdqnnjsc0z1f8wl3flnnxnk9y7km82x5pby0m7"; depends=[abind igraph ggm corpcor robustbase vcd Rcpp bdsmatrix sfsmisc fastICA clue gmp Rcpp RcppArmadillo BH]; };
pcg = derive { name="pcg"; version="1.1"; sha256="194j72hcp7ywq1q3dd493pwkn1fmdg647gmhxcd1jm6xgijhvv87"; depends=[]; };
pcnetmeta = derive { name="pcnetmeta"; version="2.2"; sha256="1zlkwx6745nlqg39f062c975277sbbakvx48r5gq0dgix8dkva9v"; depends=[rjags coda]; };
...
pegas = derive { name="pegas"; version="0.8"; sha256="0074r6vsnvdc0gkqhb3cb4dybpgp4ryf38lrfkk8vrs3y9gb7hdh"; depends=[ape adegenet]; };
...
perspectev = derive { name="perspectev"; version="1.0"; sha256="1qqhja7vqji9313dxxy1a9a50h5zxwxgc5s16lssczjachkqaibk"; depends=[ggplot2 foreach ape doParallel mapproj boot sp]; };
...
phreeqc = derive { name="phreeqc"; version="1.0-9102"; sha256="0214bsw9lwnlfk7bma1kzr5k2nv0a8smhyfwxmwbvnpcrm2yg0n7"; depends=[]; };
...
phylocurve = derive { name="phylocurve"; version="1.1.0"; sha256="03jvq9cdbch860910qjwg16y7h8jq9zn0iaak9daza65arch8fv0"; depends=[drc ape geiger phytools abind phylolm GPfit dtw]; };
...
plotmo = derive { name="plotmo"; version="3.1.1"; sha256="08vl41an94l3f7hkd2lzpqgzxsp4wyh24lnay3lpmc3ra2ycpbmg"; depends=[plotrix TeachingDemos]; };
...
plsgenomics = derive { name="plsgenomics"; version="1.3-1"; sha256="0vddhzqfix8q692mdls227m2l6zjzbjwp1ia5j9shy71ycg2fzn9"; depends=[MASS boot]; };
plspm = derive { name="plspm"; version="0.4.7"; sha256="0iy4qw4zjgqxg93a827qjcm32yipmnrl4gzn4hmskjd4khm9ngwd"; depends=[tester turner diagram shape amap]; };
...
poppr = derive { name="poppr"; version="1.1.5"; sha256="0whk06gwm171b5j2vcfqi7rdwczv109g7bw2gfnzhz4fm46nhmfk"; depends=[adegenet vegan ggplot2 phangorn ape igraph ade4 pegas reshape2]; };
...
ppiPre = derive { name="ppiPre"; version="1.7"; sha256="1z71cq32zkx3n9ablp22dw1cl334r1wrw5vvvqffgq3qvz1i6sn6"; depends=[igraph e1071]; };
...
prevR = derive { name="prevR"; version="3.1"; sha256="1x8ssz1k8vdq3zx1qhfhyq371i8s3bam2rd6bm3biha5i8icglh6"; depends=[sp rgdal ggplot2 directlabels GenKern fields gstat foreign maptools]; };
...
provenance = derive { name="provenance"; version="0.1"; sha256="1fk02r6r5vjjfm664mnlw8cil158kkjwplw6prkdamjxzv5i9ag6"; depends=[MASS smacof vegan shapes]; };
proxy = derive { name="proxy"; version="0.4-14"; sha256="1ijip1jmpm7dg11yv2rjcpkpg4p30m9acddbn49fbss9kcpl5b5i"; depends=[]; };
pryr = derive { name="pryr"; version="0.1.1"; sha256="00j81iwf2mka1a953nrgar0r4wcfi4n5nl8pidnhw51lyh2285d8"; depends=[stringr codetools Rcpp Rcpp]; };
...
psidR = derive { name="psidR"; version="1.3"; sha256="1jdxbjvc309b1bs81v57kc1g7lgfdz84bfakh9qwh8wgjqbjr06i"; depends=[data_table RCurl foreign SAScii]; };
...
pxweb = derive { name="pxweb"; version="0.5.54"; sha256="17vg480b54mcv9jbkci1rrn6zi90zzw098xzrcw3kvp583as9mar"; depends=[data_table plyr stringr RJSONIO httr]; };
...
qdap = derive { name="qdap"; version="2.2.1"; sha256="0gix6l0h6q0c2pl38d3qp3pzs1m3j96rcb9n6q9k1nh0002vfnsg"; depends=[qdapDictionaries qdapRegex qdapTools RColorBrewer chron dplyr gdata gender ggplot2 gridExtra igraph NLP openNLP plotrix RCurl reports reshape2 scales stringdist tidyr tm venneuler wordcloud xlsx XML]; };
...
rEMM = derive { name="rEMM"; version="1.0-9"; sha256="0b3g30s8nw107y5yg113xdw1s2h96mq0j5cldj01z3j676idjgw5"; depends=[proxy igraph clusterGeneration MASS]; };
...
rankdist = derive { name="rankdist"; version="0.4.1"; sha256="11lc7ggi5bv836f3bwk8gb5pry4fw4qwbj95bzg34xdascaapw59"; depends=[Rcpp hash optimx Rcpp]; };
...
rattle = derive { name="rattle"; version="3.4.1"; sha256="0p3iaaf4kc88xcjf5p30imnch34p0kplf6za6b976pfp9zw54x2n"; depends=[]; };
...
readr = derive { name="readr"; version="0.1.1"; sha256="1raw3kihksqr274p0mdigfxpg8yrhx0phwiab22sdi1vp62c8ja6"; depends=[Rcpp curl Rcpp BH]; };
readstata13 = derive { name="readstata13"; version="0.7"; sha256="14il790jgn8l9c8gxgl2s11vzff5xz77jsgdgjs044r407a72wkb"; depends=[Rcpp Rcpp]; };
...
redist = derive { name="redist"; version="1.1"; sha256="0ddwvmzmqv5nm3azia1g0x0icj1jcd7s34f1kv01phky2pmz5wy4"; depends=[Rcpp spdep sp coda Rcpp RcppArmadillo]; };
...
relsurv = derive { name="relsurv"; version="2.0-5"; sha256="0lwmdz1hm46qlkvfvvyc2v592lx2crs3cxjpkph0vg5w6a0k10i4"; depends=[survival date]; };
...
reproducer = derive { name="reproducer"; version="0.1.3"; sha256="1pz2l123xc16m1pqi95khg9r267s25igcyjgr7hn9gy623cqgzah"; depends=[openxlsx ggplot2 gridExtra tm wordcloud RColorBrewer xtable metafor]; };
rerddap = derive { name="rerddap"; version="0.1.0"; sha256="1a58vsm1m9ybafda6pak0fa7kdfscslq9855a5r2x12bzqy98k4f"; depends=[httr dplyr data_table jsonlite digest ncdf]; };
...
rgdal = derive { name="rgdal"; version="0.9-3"; sha256="011vw2pgaxgbba0a0c5ha2n0haljbn00z5km13fhgqlvhhdhzd6n"; depends=[sp sp]; };
rgenoud = derive { name="rgenoud"; version="5.7-12"; sha256="17gzkn4laylnksy8h2w8c0whcxpchsx7bwjzk1q5sfqxswclqq0g"; depends=[]; };
rgeos = derive { name="rgeos"; version="0.3-11"; sha256="1x5fna4n5ck0wfdrplj5q5cvv289fzsmlr95q86na78lvwn14fzl"; depends=[sp sp]; };
...
rglobi = derive { name="rglobi"; version="0.2.8"; sha256="1033cmwairf4nm9r6nvi1ddgq0j9mzchlzvj1hph0vlcbb53ybqh"; depends=[rjson RCurl]; };
...
rjstat = derive { name="rjstat"; version="0.2.1"; sha256="0chb3mypmgqz7wncl01yy93xpz1mmlcc6x1cib37zxc8dy79jm1s"; depends=[jsonlite assertthat]; };
...
rprime = derive { name="rprime"; version="0.1.0"; sha256="1v6n1qi0i7x8xgizbyvp1mnwc316lsan4rvam44fgjj45fcd79gd"; depends=[stringr stringi plyr assertthat]; };
...
rriskDistributions = derive { name="rriskDistributions"; version="2.1"; sha256="1sc0bj5sivclbq0grif99vclnlhg1k9dz4xdvng6vv392xkwbmfd"; depends=[mc2d eha msm tkrplot]; };
...
rsem = derive { name="rsem"; version="0.4.6"; sha256="16nsbp4s20396h2in0zymbpmsn24gqlbik0vgv86zhy1yg1rz9ia"; depends=[MASS lavaan]; };
...
sampSurf = derive { name="sampSurf"; version="0.7-3"; sha256="165y2z9bhf7cyrh177fk87apqpgzyn69gf53f9mmii931cyykihw"; depends=[sp raster rasterVis boot]; };
...
sdcTable = derive { name="sdcTable"; version="0.18.1"; sha256="18l6d6q6pawvswj1v9mfmcg4m94dkp38yd2mnndz9l7qmvf6n7kx"; depends=[stringr Rcpp Rglpk lpSolveAPI data_table Rcpp]; };
...
seqminer = derive { name="seqminer"; version="3.9"; sha256="12m0mhfnnpl8pn1mmxs7hxljpg48ppmd6yvw6lac5gpvg0q6z47a"; depends=[stringr]; };
...
shapeR = derive { name="shapeR"; version="0.1-5"; sha256="17fq4gsdvyniq7n4x1xdvb5kk50184i7why3pdf1djjhknym087j"; depends=[gplots jpeg pixmap wavethresh vegan MASS]; };
...
shiny = derive { name="shiny"; version="0.12.0"; sha256="1mv2l2jlayg8jwr2710mp5awazdxbmq2vz8ld1jr2apq9irai14l"; depends=[httpuv mime jsonlite xtable digest htmltools R6]; };
...
showtext = derive { name="showtext"; version="0.4-2"; sha256="18r1xwyjca9ccr2yf8r786pgji38myqp35abxsvd7wv7k3avhwd9"; depends=[sysfonts showtextdb]; };
...
simPH = derive { name="simPH"; version="1.3.2"; sha256="0zlzlan2syl51smc3wm52yiak82v1f3pjgsba3w677a37g3badls"; depends=[data_table dplyr ggplot2 gridExtra lazyeval MASS mgcv reshape2 stringr survival quadprog]; };
...
simcausal = derive { name="simcausal"; version="0.1"; sha256="0i39rkfmaqw0f9g3mw05rz7bf0vd4nqxwaixf8i8mvhnbn5gglv3"; depends=[data_table reshape2]; };
...
sirt = derive { name="sirt"; version="1.6-0"; sha256="0sgbg2n7ww7vafrpvkkid63i935m5kav6qzmqp2wr40gfakyax56"; depends=[TAM CDM Rcpp mirt lavaan qgraph semPlot combinat ic_infer sfsmisc sm psych pbivnorm gtools igraph coda mvtnorm MASS Matrix lavaan_survey survey Rcpp RcppArmadillo]; };
...
smcfcs = derive { name="smcfcs"; version="1.0.0"; sha256="04r8a2p8549pq8yl92ajj893w1rj03s14q6dv14vp0873zrxkxza"; depends=[VGAM MASS survival]; };
...
smoof = derive { name="smoof"; version="1.0"; sha256="10yvx5lr73kzjk7xn4jy97yzvv8qilrp7ilvk0fg5hyimbwlz13s"; depends=[ParamHelpers BBmisc checkmate ggplot2 RColorBrewer plot3D emoa]; };
...
soiltexture = derive { name="soiltexture"; version="1.3.3"; sha256="1a0j10f6mxwrslqd4fvc1nqvsh47ly1nyhc6l0qq1iz6ffqd37mx"; depends=[sp MASS]; };
...
sortinghat = derive { name="sortinghat"; version="0.1"; sha256="0j2a92mdcybq4pa3j1valczphgvqlg16wd58vlyf74ql4v28rm7r"; depends=[MASS bdsmatrix mvtnorm]; };
...
speedglm = derive { name="speedglm"; version="0.3"; sha256="07pq0ymg7x9c9pq79d476slca43jv4682iackd446glw2qffac1y"; depends=[Matrix MASS]; };
...
spsurvey = derive { name="spsurvey"; version="3.0"; sha256="15i10a6hhk1wwnyd4lbrqaql8i4s10302bxmpr0s5cyifs084l77"; depends=[sp deldir foreign MASS rgeos]; };
...
ssfa = derive { name="ssfa"; version="1.0"; sha256="119r3li4dwflm4kkk6q9hax12rhi02v7w4v2p31dq122fz10s4a6"; depends=[Matrix maxLik spdep sp]; };
...
ssizeRNA = derive { name="ssizeRNA"; version="1.1.2"; sha256="11dnc3wqj0i5blzc9ndpgl48xm5fibjgx9sxrzdcza0gbj8qpadm"; depends=[MASS ssize_fdr]; };
...
stochvol = derive { name="stochvol"; version="1.1.1"; sha256="1cfav3i7w5i3rayajdybjmwvmqvqj58zk8sk0icw52r5l4ki2d6s"; depends=[coda Rcpp Rcpp]; };
...
stream = derive { name="stream"; version="1.1-4"; sha256="1pz9ck6rxxwnzrhixs015k3sy2gl8hwxyxwr56ykpkrcn6kgzm3f"; depends=[proxy animation clue cluster clusterGeneration fpc MASS mlbench Rcpp Rcpp]; };
streamMOA = derive { name="streamMOA"; version="1.1-0"; sha256="0h45saz5jf9jfsajy987ljpfpm2cxigyqkgmybd0m3aqyrqlljbc"; depends=[stream rJava]; };
...
strum = derive { name="strum"; version="0.6.1"; sha256="128xrprdmncnn2a7z6g2qzkps323qq33g3fxh1q23ys11p37dnjw"; depends=[pedigree Matrix MASS Rcpp Rcpp RcppArmadillo]; };
...
supcluster = derive { name="supcluster"; version="1.0"; sha256="1rkd4bpzzvzbmqaj907pqv53hxcgic0jklbsf5iayf0ra768b5w6"; depends=[mvtnorm gtools]; };
...
synbreed = derive { name="synbreed"; version="0.11-4"; sha256="0vk15r9w2jyaw9i85cvigmscnwhkal4bb3ml0c6slcjhy2cpnj6p"; depends=[doBy BLR regress abind igraph lattice MASS LDheatmap qtl]; };
...
tcR = derive { name="tcR"; version="2.0"; sha256="05y3nbqdaxry7jwph6z2v8d2304xh791l0vviywyghrw7b2hqw9q"; depends=[ggplot2 dplyr gridExtra reshape2 igraph Rcpp data_table gtable roxygen2 stringdist Rcpp]; };
...
testthat = derive { name="testthat"; version="0.10.0"; sha256="0b3akwcx5mv9dmi8vssbk91hr3yrrdxd2fm6zhr31fnyz8kjx4pw"; depends=[digest crayon]; };
...
threejs = derive { name="threejs"; version="0.2.1"; sha256="01zfv5lm11i2nkb876f3fg8vsff2wk271jqs6xw1njjdhbnnihs1"; depends=[htmlwidgets base64enc]; };
...
tigerstats = derive { name="tigerstats"; version="0.2-6"; sha256="0niibqhqpjxgq3m7xp0icf98k531ncmm853scvqp5icv2yz5ivav"; depends=[abd mosaic mosaicData ggplot2 lattice MASS]; };
...
timereg = derive { name="timereg"; version="1.8.9"; sha256="12l8sz10ic8d34jd7ik8szg2d51pr949nsss20c5l5g3kfnvqkkh"; depends=[survival lava numDeriv]; };
...
tmap = derive { name="tmap"; version="1.0"; sha256="1807zh2yjgcpjrl1g83ahby7857l7hd5k9shrb1v6vkv6x5rrrkm"; depends=[sp raster gridBase rgdal rgeos classInt RColorBrewer]; };
tmg = derive { name="tmg"; version="0.3"; sha256="0yqavibinzsdh85izzsx8b3bb9l36vzkp5a3bdwdbh410s62j68a"; depends=[Rcpp Rcpp RcppEigen]; };
tmle = derive { name="tmle"; version="1.2.0-4"; sha256="06wndlqn51z71ck26l190mrg87hcvxg1p861l173rivz9k8kb404"; depends=[SuperLearner]; };
tmle_npvi = derive { name="tmle.npvi"; version="0.10.0"; sha256="00jav1ql3lv18wh9msxnjvz36z2ds44fdi6lrp1pfphh1in4vdcl"; depends=[R_utils R_methodsS3 R_oo MASS Matrix geometry]; };
...
tree = derive { name="tree"; version="1.0-35"; sha256="1jvhl21wd1dwpn1f0jkn07msgmcasdh6bnf10dxxjks20vp9b618"; depends=[]; };
...
trip = derive { name="trip"; version="1.1-21"; sha256="0rawckw3xd8kz2jn6xgspgl5axabjcp4xh4kp93n3h41xlarv9xa"; depends=[sp maptools MASS raster spatstat]; };
...
vegan = derive { name="vegan"; version="2.3-0"; sha256="1zlz2zq0818735db4l8gfwwxxd5dc0xnx6v8cq6mfclkw1qhcdpx"; depends=[permute lattice MASS cluster mgcv]; };
vegan3d = derive { name="vegan3d"; version="0.65-1"; sha256="03rzv7l2jjrahj3492ysalyizkv24by35nrhd1bnlb1s88sav7sr"; depends=[vegan rgl scatterplot3d]; };
...
virtualspecies = derive { name="virtualspecies"; version="1.1"; sha256="0znrb6xqyzddd1r999rhx6ix6wgpj1laf5bcns7zgmq6zb39j74s"; depends=[raster ade4 dismo rworldmap]; };
...
wppExplorer = derive { name="wppExplorer"; version="1.6-2"; sha256="1y9mdghq4is81gabx47pm1kfay67zv3b9hxz58lhml68wwwsfmsj"; depends=[shiny plyr reshape2 googleVis wpp2012 Hmisc ggplot2]; };
...
wsrf = derive { name="wsrf"; version="1.5.0"; sha256="19vnvy0yijfhgvl5djwvhrvbbcjxjzp5xq7hskiz8lpfyhxynmhl"; depends=[Rcpp Rcpp]; };
...
x_ent = derive { name="x.ent"; version="1.1.2"; sha256="0wbbhsnlm5yln72h648nz3y5w83kq9qvpw0pk56lsc1bafps712p"; depends=[opencpu rJava stringr xtable jsonlite venneuler ggplot2 statmod]; };
...
yuima = derive { name="yuima"; version="1.0.71"; sha256="0aqb87jlvlq6iw2mlngiylvayd6y2wrc82zl1za442gqq8py00if"; depends=[zoo expm cubature mvtnorm]; };
