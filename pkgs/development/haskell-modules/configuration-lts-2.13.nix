...
self: super: {
  ...
  "persistent-template" = doDistribute super."persistent-template_2_1_3_3";
  ...
  "simple-sendfile" = doDistribute super."simple-sendfile_0_2_20";
  ...
  "warp-tls" = doDistribute super."warp-tls_3_0_4";
